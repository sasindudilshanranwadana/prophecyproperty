            ...
            <div className={styles.sectionParent}>
              <div className={styles.section}>
                ...
                <div className={styles.list}>
                  ...
                  />
                  <div className={styles.storyTrioParent}>
                    <div className={styles.storyTrio}>
                      ...
                      <div className={styles.storyHeadings}>
                    ...
                    <div className={styles.storyTrio1}>
                      <div className={styles.picture1}>
                        <img
                          className={styles.bedroomApartmentjpgIcon}
                          loading="lazy"
                    ...
                    <div className={styles.rebuildStory}>
                      <div className={styles.picture1}>
                        <img
                          className={styles.bedroomApartmentjpgIcon}
                          alt=""
                    ...
                    <div className={styles.rebuildStory}>
                      ...
                      <div className={styles.heading3Container}>
                        ...
                        <div className={styles.rebuildPresenter}>
                          <div className={styles.knockdownSponsorLogo}>
                            <a
