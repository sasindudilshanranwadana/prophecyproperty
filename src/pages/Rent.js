...
const Rent = () => {
  ...
  return (
    <div className={styles.rent}>
      <Header />
      <main className={styles.rentInner}>
              ...
              <div className={styles.background}>
                <div className={styles.horizontalborderWrapper}>
                  <div className={styles.horizontalborder}>
                    <div className={styles.homeSearchTabItems}>
                      <div className={styles.buy}>Buy</div>
                    </div>
                    <div className={styles.homeSearchTabItems1}>
                      <div className={styles.buy}>Rent</div>
                    </div>
                    <div className={styles.horizontalDivider} />
                    <div className={styles.homeSearchTabItems2}>
            ...
            <div className={styles.sectionParent}>
              <div className={styles.section}>
                ...
                <div className={styles.list}>
                  ...
                  />
                  <div className={styles.bedroomArticle}>
                    <div
                  ...
                  <div className={styles.link2} onClick={onLinkContainerClick1}>
                    ...
                    <div className={styles.secondNews}>
                      ...
                      <div className={styles.tipContentParent}>
