...
import styles from "./HeroInnerContent1.module.css";

const HeroInnerContent1 = ({ className = "" }) => {
        ...
        <div className={styles.background}>
          <div className={styles.horizontalborderWrapper}>
            <div className={styles.horizontalborder}>
              ...
              <div className={styles.filterTabList1}>
                <div className={styles.buy}>Rent</div>
              </div>
              <div className={styles.filterTabList2}>
      ...
      <div className={styles.sectionParent}>
        <div className={styles.section}>
          ...
          <div className={styles.list}>
            ...
            />
            <div className={styles.cheapestBedroom}>
            ...
            <div className={styles.link2} onClick={onLinkContainerClick1}>
              ...
              <div className={styles.knockdownArticle}>
                ...
                <div className={styles.frameParent}>
                  <div className={styles.presentedByWrapper}>
                    <a
...
HeroInnerContent1.propTypes = {
  className: PropTypes.string,
};

export default HeroInnerContent1;
